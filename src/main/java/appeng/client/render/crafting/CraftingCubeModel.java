...
class CraftingCubeModel implements IModel
{
	...
	public Collection<ResourceLocation> getTextures()
	{
		return ImmutableList.of( RING_CORNER, RING_SIDE_HOR, RING_SIDE_VER, UNIT_BASE, LIGHT_BASE, ACCELERATOR_1_LIGHT, ACCELERATOR_4_LIGHT, ACCELERATOR_16_LIGHT, ACCELERATOR_64_LIGHT,
				STORAGE_1K_LIGHT, STORAGE_4K_LIGHT, STORAGE_16K_LIGHT, STORAGE_64K_LIGHT, STORAGE_256K_LIGHT, STORAGE_1M_LIGHT, STORAGE_4M_LIGHT, STORAGE_16M_LIGHT, MONITOR_BASE, MONITOR_LIGHT_DARK, MONITOR_LIGHT_MEDIUM, MONITOR_LIGHT_BRIGHT );
	}
